...
def test_words_or_letters_counter():
    ...
    assert words_or_letters_dict_creator(list_of_words) == {'some': 2, 'exaple': 1, 'text': 1, 'given': 1, 'here': 1, 'just': 1,
                                            'for': 1, 'fun': 1}

    assert words_or_letters_dict_creator(list_od_letters) == {'h': 1, 'e': 1, 'l': 3, 'o': 2, 'w': 1, 'r': 1, 'd': 1}
